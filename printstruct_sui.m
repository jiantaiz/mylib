function pS = printstruct_sui(S, varargin)
...
if printValues == 0
    ...
    for iField  = 1 : length(noStrucFields)
        ...
        filler = [];
        listStr = [listStr; {[strIndent sepbar filler ' ' Field]}];
    end
    return
end
...
for iField = 1 : length(charFields)
    ...
    listStr = [listStr; {[strIndent sepbar filler ' ' Field ' :' varStr]}];
end
% Print empty fields
